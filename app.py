    ...
    if verificar_senha():
        ...
        if menu == "1. Cadastro de Médicos":
            ...
            if res.data:
                ...
                c1, c2 = st.columns(2)
                d = c1.date_input("Data", format="DD/MM/YYYY") # DATA BR
                ...
                if st.button("Gerar Grade"):
                    ...
                    st.success(f"✅ Grade criada para {d.strftime('%d/%m/%Y')}!")
            ...
            try:
                ...
                if res.data:
                    ...
                    for r in res.data:
                        ...
                        lista.append({'id': r['id'], 'info': f"{pac} | {dt} | Dr(a): {m.get('nome')}"})
                ...
                else: st.info("Sem consultas marcadas.")
            except Exception as e: st.error(f"Erro: {e}")
